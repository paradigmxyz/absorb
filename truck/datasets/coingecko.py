...
class CategoryMetrics(truck.Table):
    source = 'coingecko'
    write_range = 'overwrite_all'
    range_format = 'date_range'
    parameter_types = {'catgories': list[str]}
    ...
    def collect_chunk(self, data_range: typing.Any) -> pl.DataFrame:
        coin_metrics = truck.load('coingecko.coin_metrics')
        coin_categories = truck.load('coingecko.categories')
