...
def path_command(args: Namespace) -> dict[str, Any]:
    if args.dataset is None:
        print(truck.ops.get_truck_root(warn=False))
    elif args.glob:
        ...
        print(truck.ops.get_table_dir(source=source, table=table, warn=False))
    else:
        print(truck.ops.get_source_dir(args.dataset, warn=False))
    return {}
